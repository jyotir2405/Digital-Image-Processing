...
text(size(img,2)/2,size(img,1)/2,'MESSI','FontSize',50,'Color','white','FontWeight','bold','HorizontalAlignment','center');
frame=getframe(gca);
...
imwrite(img_watermarked,'text_watermarked_image_jyotir.png');
figure;
...
imwrite(img_cleaned,'text_watermark_removed_jyotir.png');
figure;
